...
- [ ] Add cross-entropy loss because is more suitable for classification in combination with softmax (Maybe let the user choice between MSE and cross entropy through NN\_train\_opt).
